...
<script defer>
    function heatmap(floor = 1) {
        fetch('<?= route('getHeatMapData') ?>', {
            method: 'POST',
            body: JSON.stringify(
                {
                    floor: floor
            ...
            if(response.ok){
                console.log('hjghcghgj')
                response.json().then((result) => {console.log(result); generateHeatmap(result)} )
            }
    ...
    function fetchHeatmapData(floor = 1, age = null, gender = null, fromm = null, too = null) {
        fetch('<?= route('getHeatMapData') ?>', {
            method: 'POST',
            body: JSON.stringify(
                {
            ...
            if(response.ok){
                ...
                response.json().then((result) => {generateHeatmap(result)} )
            }
            throw new Error('Request failed!');
        }, networkError => {
            console.log(networkError.message);
